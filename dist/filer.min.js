...
var global = arguments[3];
var t=arguments[3],e=require("../constants.js").FILE_SYSTEM_NAME,r=require("../constants.js").FILE_STORE_NAME,n=require("../constants.js").IDB_RW,o=require("../constants.js").IDB_RO,u=require("../errors.js"),c=require("../buffer.js"),i=t.indexedDB||t.mozIndexedDB||t.webkitIndexedDB||t.msIndexedDB;function s(t,e){this.db=t,this.mode=e}function a(t){this.name=t||e,this.db=null}s.prototype._getObjectStore=function(){if(this.objectStore)return this.objectStore;var t=this.db.transaction(r,this.mode);return this.objectStore=t.objectStore(r),this.objectStore},s.prototype.clear=function(t){try{var e=this._getObjectStore().clear();e.onsuccess=function(){t()},e.onerror=function(e){e.preventDefault(),t(e.error)}}catch(e){t(e)}},s.prototype._get=function(t,e){try{var r=this._getObjectStore().get(t);r.onsuccess=function(t){var r=t.target.result;e(null,r)},r.onerror=function(t){t.preventDefault(),e(t.error)}}catch(t){e(t)}},s.prototype.getObject=function(t,e){this._get(t,e)},s.prototype.getBuffer=function(t,e){this._get(t,function(t,r){if(t)return e(t);e(null,new c(r))})},s.prototype._put=function(t,e,r){try{var n=this._getObjectStore().put(e,t);n.onsuccess=function(t){var e=t.target.result;r(null,e)},n.onerror=function(t){t.preventDefault(),r(t.error)}}catch(t){r(t)}},s.prototype.putObject=function(t,e,r){this._put(t,e,r)},s.prototype.putBuffer=function(t,e,r){var n=e.buffer;this._put(t,n,r)},s.prototype.delete=function(t,e){try{var r=this._getObjectStore().delete(t);r.onsuccess=function(t){var r=t.target.result;e(null,r)},r.onerror=function(t){t.preventDefault(),e(t.error)}}catch(t){e(t)}},a.isSupported=function(){return!!i},a.prototype.open=function(t){var e=this;if(e.db)return t();try{var n=i.open(e.name);n.onupgradeneeded=function(t){var e=t.target.result;e.objectStoreNames.contains(r)&&e.deleteObjectStore(r),e.createObjectStore(r)},n.onsuccess=function(r){e.db=r.target.result,t()},n.onerror=function(e){e.preventDefault(),t(e.error)}}catch(e){t(e)}},a.prototype.getReadOnlyContext=function(){return new s(this.db,o)},a.prototype.getReadWriteContext=function(){return new s(this.db,n)},module.exports=a;
...
},{"../constants.js":16,"../errors.js":5,"../buffer.js":3,"base64-arraybuffer":69}],46:[function(require,module,exports) {
...
},{"process":46}],57:[function(require,module,exports) {
...
},{"../constants.js":16,"../../lib/async.js":21}],19:[function(require,module,exports) {
...
},{"./indexeddb.js":55,"./websql.js":56,"./memory.js":57}],24:[function(require,module,exports) {
...
},{"concat-map":67,"balanced-match":68}],30:[function(require,module,exports) {
...
},{"path":43,"brace-expansion":44}],7:[function(require,module,exports) {
var n=require("../path.js"),t=require("../errors.js"),e=require("./environment.js"),i=require("../../lib/async.js"),r=require("../encoding.js"),o=require("minimatch");function u(i,r){var o=new e((r=r||{}).env),u="/";Object.defineProperty(this,"fs",{get:function(){return i},enumerable:!0}),Object.defineProperty(this,"env",{get:function(){return o},enumerable:!0}),this.cd=function(e,r){e=n.resolve(u,e),i.stat(e,function(n,i){n?r(new t.ENOTDIR(null,e)):"DIRECTORY"===i.type?(u=e,r()):r(new t.ENOTDIR(null,e))})},this.pwd=function(){return u}}u.prototype.exec=function(t,e,i){var r=this.fs;"function"==typeof e&&(i=e,e=[]),e=e||[],i=i||function(){},t=n.resolve(this.pwd(),t),r.readFile(t,"utf8",function(n,t){if(n)i(n);else try{new Function("fs","args","callback",t)(r,e,i)}catch(n){i(n)}})},u.prototype.touch=function(t,e,i){var r=this.fs;"function"==typeof e&&(i=e,e={}),e=e||{},i=i||function(){},t=n.resolve(this.pwd(),t),r.stat(t,function(n,o){n?!0===e.updateOnly?i():function(n){r.writeFile(n,"",i)}(t):function(n){var t=Date.now(),o=e.date||t,u=e.date||t;r.utimes(n,o,u,i)}(t)})},u.prototype.cat=function(e,r){var o=this,u=o.fs,f="";r=r||function(){},e?(e="string"==typeof e?[e]:e,i.eachSeries(e,function(t,e){var i=n.resolve(o.pwd(),t);u.readFile(i,"utf8",function(n,t){n?e(n):(f+=t+"\n",e())})},function(n){n?r(n):r(null,f.replace(/\n$/,""))})):r(new t.EINVAL("Missing files argument"))},u.prototype.ls=function(e,r,o){var u=this,f=u.fs;"function"==typeof r&&(o=r,r={}),r=r||{},o=o||function(){},e?function t(e,o){var c=n.resolve(u.pwd(),e),s=[];f.readdir(c,function(e,u){e?o(e):i.eachSeries(u,function(e,i){e=n.join(c,e),f.stat(e,function(o,u){if(o)i(o);else{var f={path:n.basename(e),links:u.nlinks,size:u.size,modified:u.mtime,type:u.type};r.recursive&&"DIRECTORY"===u.type?t(n.join(c,f.path),function(n,t){n?i(n):(f.contents=t,s.push(f),i())}):(s.push(f),i())}})},function(n){o(n,s)})})}(e,o):o(new t.EINVAL("Missing dir argument"))},u.prototype.rm=function(e,r,o){var u=this,f=u.fs;"function"==typeof r&&(o=r,r={}),r=r||{},o=o||function(){},e?function e(o,c){o=n.resolve(u.pwd(),o),f.stat(o,function(u,s){u?c(u):"FILE"!==s.type?f.readdir(o,function(u,s){u?c(u):0!==s.length?r.recursive?(s=s.map(function(t){return n.join(o,t)}),i.eachSeries(s,e,function(n){n?c(n):f.rmdir(o,c)})):c(new t.ENOTEMPTY(null,o)):f.rmdir(o,c)}):f.unlink(o,c)})}(e,o):o(new t.EINVAL("Missing path argument"))},u.prototype.tempDir=function(n){var t=this.fs,e=this.env.get("TMP");n=n||function(){},t.mkdir(e,function(t){n(null,e)})},u.prototype.mkdirp=function(e,i){var r=this.fs;i=i||function(){},e?"/"!==e?function e(i,o){r.stat(i,function(u,f){if(f){if(f.isDirectory())return void o();if(f.isFile())return void o(new t.ENOTDIR(null,i))}else{if(u&&"ENOENT"!==u.code)return void o(u);var c=n.dirname(i);"/"===c?r.mkdir(i,function(n){n&&"EEXIST"!=n.code?o(n):o()}):e(c,function(n){if(n)return o(n);r.mkdir(i,function(n){n&&"EEXIST"!=n.code?o(n):o()})})}})}(e,i):i():i(new t.EINVAL("Missing path argument"))},u.prototype.find=function(e,r,u){var f=this,c=f.fs;"function"==typeof r&&(u=r,r={}),u=u||function(){};var s=(r=r||{}).exec||function(n,t){t()},a=[];function p(t,e){var i=n.removeTrailing(t);!r.regex||r.regex.test(i)?r.name&&!o(n.basename(i),r.name)||r.path&&!o(n.dirname(i),r.path)?e():function(n,t){s(n,function(e){e?t(e):(a.push(n),t())})}(t,e):e()}function d(t,e){t=n.resolve(f.pwd(),t),c.readdir(t,function(r,o){r?"ENOTDIR"===r.code?p(t,e):e(r):p(n.addTrailing(t),function(r){r?e(r):(o=o.map(function(e){return n.join(t,e)}),i.eachSeries(o,d,function(n){e(n,a)}))})})}e?c.stat(e,function(n,i){n?u(n):i.isDirectory()?d(e,u):u(new t.ENOTDIR(null,e))}):u(new t.EINVAL("Missing path argument"))},module.exports=u;
},{"../path.js":4,"../errors.js":5,"./environment.js":24,"../../lib/async.js":21,"../encoding.js":22,"minimatch":30}],45:[function(require,module,exports) {
...
},{"./eventemitter.js":45,"../src/shared.js":15}],18:[function(require,module,exports) {
...
},{"../lib/eventemitter.js":45,"./path.js":4,"../lib/intercom.js":17}],50:[function(require,module,exports) {
...
},{"./errors.js":5}],52:[function(require,module,exports) {
...
},{"./constants.js":16}],53:[function(require,module,exports) {
...
},{"./constants.js":16}],54:[function(require,module,exports) {
...
>>>>>>> Switch to parceljs for bundling, eslint for linting, drop grunt
=======
var n=require("../../lib/nodash.js"),e=require("../path.js"),t=e.normalize,i=e.dirname,o=e.basename,a=e.isAbsolute,u=e.isNull,c=require("../constants.js"),r=c.MODE_FILE,f=c.MODE_DIRECTORY,s=c.MODE_SYMBOLIC_LINK,l=c.MODE_META,d=c.ROOT_DIRECTORY_NAME,m=c.SUPER_NODE_ID,E=c.SYMLOOP_MAX,p=c.O_READ,w=c.O_WRITE,g=c.O_CREATE,O=c.O_EXCLUSIVE,b=c.O_TRUNCATE,v=c.O_APPEND,N=c.O_FLAGS,I=c.XATTR_CREATE,h=c.XATTR_REPLACE,A=c.FS_NOMTIME,T=c.FS_NOCTIME,D=require("../encoding.js"),j=require("../errors.js"),R=require("../directory-entry.js"),y=require("../open-file-description.js"),L=require("../super-node.js"),V=require("../node.js"),F=require("../stats.js"),B=require("../buffer.js");function _(e,t,i,o,a){var u=e.flags;n(u).contains(T)&&delete o.ctime,n(u).contains(A)&&delete o.mtime;var c=!1;function r(n){e.changes.push({event:"change",path:t}),a(n)}o.ctime&&(i.ctime=o.ctime,i.atime=o.ctime,c=!0),o.atime&&(i.atime=o.atime,c=!0),o.mtime&&(i.mtime=o.mtime,c=!0),c?e.putObject(i.id,i,r):r()}function x(n,e,a,u){if(a!==f&&a!==r)return u(new j.EINVAL("mode must be a directory or file",e));e=t(e);var c,s,l,d=o(e),m=i(e);function E(t,i){!t&&i?u(new j.EEXIST("path name already exists",e)):!t||t instanceof j.ENOENT?n.getObject(c.data,p):u(t)}function p(e,t){e?u(e):(s=t,V.create({guid:n.guid,mode:a},function(e,t){e?u(e):((l=t).nlinks+=1,n.putObject(l.id,l,g))}))}function w(e){if(e)u(e);else{var t=Date.now();_(n,m,l,{mtime:t,ctime:t},u)}}function g(e){e?u(e):(s[d]=new R(l.id,a),n.putObject(c.data,s,w))}S(n,m,function(t,i){t?u(t):i.mode!==f?u(new j.ENOTDIR("a component of the path prefix is not a directory",e)):(c=i,S(n,e,E))})}function S(e,a,u){if(!(a=t(a)))return u(new j.ENOENT("path is an empty string"));var c=o(a),r=i(a),p=0;function w(n,t){n?u(n):t&&t.mode===l&&t.rnode?e.getObject(t.rnode,g):u(new j.EFILESYSTEMERROR)}function g(n,e){n?u(n):e?u(null,e):u(new j.ENOENT)}function O(n,t){n?u(n):t.mode===f&&t.data?e.getObject(t.data,b):u(new j.ENOTDIR("a component of the path prefix is not a directory",a))}function b(t,i){if(t)u(t);else if(n(i).has(c)){var o=i[c].id;e.getObject(o,v)}else u(new j.ENOENT(null,a))}function v(n,f){var l;n?u(n):f.mode==s?++p>E?u(new j.ELOOP(null,a)):(l=f.data,l=t(l),r=i(l),c=o(l),d==c?e.getObject(m,w):S(e,r,O)):u(null,f)}d==c?e.getObject(m,w):S(e,r,O)}function C(n,e,t,i,o,a,u){var c=t.xattrs;a===I&&c.hasOwnProperty(i)?u(new j.EEXIST("attribute already exists",e)):a!==h||c.hasOwnProperty(i)?(c[i]=o,n.putObject(t.id,t,function(i){i?u(i):_(n,e,t,{ctime:Date.now()},u)})):u(new j.ENOATTR(null,e))}function P(n,e){var t,i,o;function a(o){o?e(o):V.create({guid:n.guid,id:t.rnode,mode:f},function(t,o){t?e(t):((i=o).nlinks+=1,n.putObject(i.id,i,u))})}function u(t){t?e(t):(o={},n.putObject(i.data,o,e))}n.getObject(m,function(i,o){!i&&o?e():!i||i instanceof j.ENOENT?L.create({guid:n.guid},function(i,o){i?e(i):(t=o,n.putObject(t.id,t,a))}):e(i)})}function k(n,e,a){e=t(e);var u,c,r,s,l=o(e),d=i(e);function m(e,t){e?a(e):(r=t,n.getObject(r.data,E))}function E(e,t){e?a(e):(s=t,V.create({guid:n.guid,mode:f},function(e,t){e?a(e):((u=t).nlinks+=1,n.putObject(u.id,u,p))}))}function p(e){e?a(e):(c={},n.putObject(u.data,c,g))}function w(e){if(e)a(e);else{var t=Date.now();_(n,d,r,{mtime:t,ctime:t},a)}}function g(e){e?a(e):(s[l]=new R(u.id,f),n.putObject(r.data,s,w))}S(n,e,function(t,i){!t&&i?a(new j.EEXIST(null,e)):!t||t instanceof j.ENOENT?S(n,d,m):a(t)})}function M(e,a,u){a=t(a);var c,r,s,l=o(a),m=i(a);function E(t,i){t?u(t):d==l?u(new j.EBUSY(null,a)):n(i).has(l)?(c=(s=i)[l].id,e.getObject(c,p)):u(new j.ENOENT(null,a))}function p(n,t){n?u(n):t.mode!=f?u(new j.ENOTDIR(null,a)):(c=t,e.getObject(c.data,w))}function w(t,i){t?u(t):n(i).size()>0?u(new j.ENOTEMPTY(null,a)):(delete s[l],e.putObject(r.data,s,g))}function g(n){if(n)u(n);else{var t=Date.now();_(e,m,r,{mtime:t,ctime:t},O)}}function O(n){n?u(n):e.delete(c.id,b)}function b(n){n?u(n):e.delete(c.data,u)}S(e,m,function(n,t){n?u(n):(r=t,e.getObject(r.data,E))})}function X(e,a,u,c){a=t(a);var l,m,p,b,v,N=o(a),I=i(a),h=0;function A(n,t){n?c(n):t.mode!==f?c(new j.ENOENT(null,a)):(l=t,e.getObject(l.data,T))}function T(t,i){t?c(t):n(m=i).has(N)?n(u).contains(O)?c(new j.ENOENT("O_CREATE and O_EXCLUSIVE are set, and the named file exists",a)):(p=m[N]).type==f&&n(u).contains(w)?c(new j.EISDIR("the named file is a directory and O_WRITE is set",a)):e.getObject(p.id,D):n(u).contains(g)?V.create({guid:e.guid,mode:r},function(n,t){n?c(n):((b=t).nlinks+=1,e.putObject(b.id,b,L))}):c(new j.ENOENT("O_CREATE is not set and the named file does not exist",a))}function D(r,f){if(r)c(r);else{var l=f;l.mode==s?++h>E?c(new j.ELOOP(null,a)):function(r){r=t(r),I=i(r),N=o(r),d==N&&(n(u).contains(w)?c(new j.EISDIR("the named file is a directory and O_WRITE is set",a)):S(e,a,y));S(e,I,A)}(l.data):y(void 0,l)}}function y(n,e){n?c(n):c(null,b=e)}function L(n){n?c(n):((v=new B(0)).fill(0),e.putBuffer(b.data,v,x))}function F(n){if(n)c(n);else{var t=Date.now();_(e,I,l,{mtime:t,ctime:t},C)}}function x(n){n?c(n):(m[N]=new R(b.id,r),e.putObject(l.data,m,F))}function C(n){n?c(n):c(null,b)}d==N?n(u).contains(w)?c(new j.EISDIR("the named file is a directory and O_WRITE is set",a)):S(e,a,y):S(e,I,A)}function z(n,e,t,i,o,a){var u;function c(n){n?a(n):a(null,o)}function r(t){if(t)a(t);else{var i=Date.now();_(n,e.path,u,{mtime:i,ctime:i},c)}}function f(e){e?a(e):n.putObject(u.id,u,r)}n.getObject(e.id,function(c,r){if(c)a(c);else{u=r;var s=new B(o);s.fill(0),t.copy(s,0,i,i+o),e.position=o,u.size=o,u.version+=1,n.putBuffer(u.data,s,f)}})}function q(n,e,t,i,o,a,u){var c,r;function f(n){n?u(n):u(null,o)}function s(t){if(t)u(t);else{var i=Date.now();_(n,e.path,c,{mtime:i,ctime:i},f)}}function l(e){e?u(e):n.putObject(c.id,c,s)}function d(f,s){if(f)u(f);else{if(!(r=s))return u(new j.EIO("Expected Buffer"));var d=null!=a?a:e.position,m=Math.max(r.length,d+o),E=new B(m);E.fill(0),r&&r.copy(E),t.copy(E,d,i,i+o),void 0===a&&(e.position+=o),c.size=m,c.version+=1,n.putBuffer(c.data,E,l)}}n.getObject(e.id,function(e,t){e?u(e):(c=t,n.getBuffer(c.data,d))})}function Y(n,e,t,i,o,a,u){var c,r;function f(n,c){if(n)u(n);else{if(!(r=c))return u(new j.EIO("Expected Buffer"));var f=null!=a?a:e.position;o=f+o>t.length?o-f:o,r.copy(t,i,f,f+o),void 0===a&&(e.position+=o),u(null,o)}}n.getObject(e.id,function(t,i){t?u(t):"DIRECTORY"===i.mode?u(new j.EISDIR("the named file is a directory",e.path)):(c=i,n.getBuffer(c.data,f))})}function U(n,e,i){e=t(e);o(e);S(n,e,i)}function W(n,e,t){e.getNode(n,t)}function G(e,a,u){a=t(a);var c,r,f=o(a),s=i(a);function l(t,i){t?u(t):n(r=i).has(f)?e.getObject(r[f].id,u):u(new j.ENOENT("a component of the path does not name an existing file",a))}d==f?S(e,a,u):S(e,s,function(n,t){n?u(n):(c=t,e.getObject(c.data,l))})}function K(e,a,u,c){a=t(a);var r=o(a),f=i(a);u=t(u);var s,l,d,m,E,p=o(u),w=i(u);function g(n){n?c(n):_(e,u,E,{ctime:Date.now()},c)}function O(n,t){n?c(n):((E=t).nlinks+=1,e.putObject(E.id,E,g))}function b(n,t){n?c(n):e.getObject(m[p].id,O)}function v(t,i){t?c(t):n(m=i).has(p)?c(new j.EEXIST("newpath resolves to an existing file",p)):(m[p]=l[r],e.putObject(d.data,m,b))}function N(n,t){n?c(n):(d=t,e.getObject(d.data,v))}function I(t,i){t?c(t):n(l=i).has(r)?"DIRECTORY"===l[r].type?c(new j.EPERM("oldpath refers to a directory")):S(e,w,N):c(new j.ENOENT("a component of either path prefix does not exist",r))}S(e,f,function(n,t){n?c(n):(s=t,e.getObject(s.data,I))})}function H(e,a,u){a=t(a);var c,r,f,s=o(a),l=i(a);function d(n){n?u(n):(delete r[s],e.putObject(c.data,r,function(n){var t=Date.now();_(e,l,c,{mtime:t,ctime:t},u)}))}function m(n){n?u(n):e.delete(f.data,d)}function E(n,t){n?u(n):"DIRECTORY"===t.mode?u(new j.EPERM("unlink not permitted on directories",s)):function(n,t){n?u(n):((f=t).nlinks-=1,f.nlinks<1?e.delete(f.id,m):e.putObject(f.id,f,function(n){_(e,a,f,{ctime:Date.now()},d)}))}(null,t)}function p(t,i){t?u(t):n(r=i).has(s)?e.getObject(r[s].id,E):u(new j.ENOENT("a component of the path does not name an existing file",s))}S(e,l,function(n,t){n?u(n):(c=t,e.getObject(c.data,p))})}function J(n,e,i){e=t(e);var a,u;o(e);function c(n,e){if(n)i(n);else{u=e;var t=Object.keys(u);i(null,t)}}S(n,e,function(t,o){t?i(t):o.mode!==f?i(new j.ENOTDIR(null,e)):(a=o,n.getObject(a.data,c))})}function Q(e,a,u,c){u=t(u);var r,f,l,m=o(u),E=i(u);function p(t,i){t?c(t):n(f=i).has(m)?c(new j.EEXIST(null,m)):V.create({guid:e.guid,mode:s},function(n,t){n?c(n):((l=t).nlinks+=1,l.size=a.length,l.data=a,e.putObject(l.id,l,g))})}function w(n){if(n)c(n);else{var t=Date.now();_(e,E,r,{mtime:t,ctime:t},c)}}function g(n){n?c(n):(f[m]=new R(l.id,s),e.putObject(r.data,f,w))}d==m?c(new j.EEXIST(null,m)):S(e,E,function(n,t){n?c(n):(r=t,e.getObject(r.data,p))})}function Z(e,a,u){a=t(a);var c,r,f=o(a),l=i(a);function d(t,i){t?u(t):n(r=i).has(f)?e.getObject(r[f].id,m):u(new j.ENOENT("a component of the path does not name an existing file",f))}function m(n,e){n?u(n):e.mode!=s?u(new j.EINVAL("path not a symbolic link",a)):u(null,e.data)}S(e,l,function(n,t){n?u(n):(c=t,e.getObject(c.data,d))})}function $(n,e,i,o){var a;function u(e,t){if(e)o(e);else{if(!t)return o(new j.EIO("Expected Buffer"));var u=new B(i);u.fill(0),t&&t.copy(u),n.putBuffer(a.data,u,r)}}function c(t){if(t)o(t);else{var i=Date.now();_(n,e,a,{mtime:i,ctime:i},o)}}function r(e){e?o(e):(a.size=i,a.version+=1,n.putObject(a.id,a,c))}e=t(e),i<0?o(new j.EINVAL("length cannot be negative")):S(n,e,function(t,i){t?o(t):i.mode==f?o(new j.EISDIR(null,e)):(a=i,n.getBuffer(a.data,u))})}function nn(n,e,t,i){var o;function a(e,a){if(e)i(e);else{var u;if(!a)return i(new j.EIO("Expected Buffer"));a?u=a.slice(0,t):(u=new B(t)).fill(0),n.putBuffer(o.data,u,c)}}function u(t){if(t)i(t);else{var a=Date.now();_(n,e.path,o,{mtime:a,ctime:a},i)}}function c(e){e?i(e):(o.size=t,o.version+=1,n.putObject(o.id,o,u))}t<0?i(new j.EINVAL("length cannot be negative")):e.getNode(n,function(e,t){e?i(e):t.mode==f?i(new j.EISDIR):(o=t,n.getBuffer(o.data,a))})}function en(n,e,i,o,a){e=t(e),"number"!=typeof i||"number"!=typeof o?a(new j.EINVAL("atime and mtime must be number",e)):i<0||o<0?a(new j.EINVAL("atime and mtime must be positive integers",e)):S(n,e,function(t,u){t?a(t):_(n,e,u,{atime:i,ctime:o,mtime:o},a)})}function tn(n,e,t,i,o){"number"!=typeof t||"number"!=typeof i?o(new j.EINVAL("atime and mtime must be a number")):t<0||i<0?o(new j.EINVAL("atime and mtime must be positive integers")):e.getNode(n,function(a,u){a?o(a):_(n,e.path,u,{atime:t,ctime:i,mtime:i},o)})}function on(n,e,i,o,a,u){e=t(e),"string"!=typeof i?u(new j.EINVAL("attribute name must be a string",e)):i?null!==a&&a!==I&&a!==h?u(new j.EINVAL("invalid flag, must be null, XATTR_CREATE or XATTR_REPLACE",e)):S(n,e,function(t,c){if(t)return u(t);C(n,e,c,i,o,a,u)}):u(new j.EINVAL("attribute name cannot be an empty string",e))}function an(n,e,t,i,o,a){"string"!=typeof t?a(new j.EINVAL("attribute name must be a string")):t?null!==o&&o!==I&&o!==h?a(new j.EINVAL("invalid flag, must be null, XATTR_CREATE or XATTR_REPLACE")):e.getNode(n,function(u,c){if(u)return a(u);C(n,e.path,c,t,i,o,a)}):a(new j.EINVAL("attribute name cannot be an empty string"))}function un(n,e,i,o){e=t(e),"string"!=typeof i?o(new j.EINVAL("attribute name must be a string",e)):i?S(n,e,function(n,t){if(n)return o(n);var a=t.xattrs;a.hasOwnProperty(i)?o(null,a[i]):o(new j.ENOATTR(null,e))}):o(new j.EINVAL("attribute name cannot be an empty string",e))}function cn(n,e,t,i){"string"!=typeof t?i(new j.EINVAL):t?e.getNode(n,function(n,e){if(n)return i(n);var o=e.xattrs;o.hasOwnProperty(t)?i(null,o[t]):i(new j.ENOATTR)}):i(new j.EINVAL("attribute name cannot be an empty string"))}function rn(n,e,i,o){e=t(e),"string"!=typeof i?o(new j.EINVAL("attribute name must be a string",e)):i?S(n,e,function(t,a){if(t)return o(t);var u=a.xattrs;u.hasOwnProperty(i)?(delete u[i],n.putObject(a.id,a,function(t){t?o(t):_(n,e,a,{ctime:Date.now()},o)})):o(new j.ENOATTR(null,e))}):o(new j.EINVAL("attribute name cannot be an empty string",e))}function fn(n,e,t,i){"string"!=typeof t?i(new j.EINVAL("attribute name must be a string")):t?e.getNode(n,function(o,a){if(o)return i(o);var u=a.xattrs;u.hasOwnProperty(t)?(delete u[t],n.putObject(a.id,a,function(t){t?i(t):_(n,e.path,a,{ctime:Date.now()},i)})):i(new j.ENOATTR)}):i(new j.EINVAL("attribute name cannot be an empty string"))}function sn(e){return n(N).has(e)?N[e]:null}function ln(n,e,t){return n?"function"==typeof n?n={encoding:e,flag:t}:"string"==typeof n&&(n={encoding:n,flag:t}):n={encoding:e,flag:t},n}function dn(n,e){var t;return n?u(n)?t=new j.EINVAL("Path must be a string without null bytes.",n):a(n)||(t=new j.EINVAL("Path must be absolute.",n)):t=new j.EINVAL("Path must be a string",n),!t||(e(t),!1)}function mn(e,t,i,o,a,u){u=arguments[arguments.length-1],dn(i,u)&&((o=sn(o))||u(new j.EINVAL("flags is not valid"),i),X(t,i,o,function(t,a){if(t)u(t);else{var c;c=n(o).contains(v)?a.size:0;var r=new y(i,a.id,o,c),f=e.allocDescriptor(r);u(null,f)}}))}function En(e,t,i,o){n(e.openFiles).has(i)?(e.releaseDescriptor(i),o(null)):o(new j.EBADF)}function pn(n,e,t,i,o){dn(t,o)&&x(e,t,i,o)}function wn(n,e,t,i,o){dn(t,o=arguments[arguments.length-1])&&k(e,t,o)}function gn(n,e,t,i){dn(t,i)&&M(e,t,i)}function On(n,e,t,i){dn(t,i)&&U(e,t,function(e,t){if(e)i(e);else{var o=new F(t,n.name);i(null,o)}})}function bn(n,e,t,i){var o=n.openFiles[t];o?W(e,o,function(e,t){if(e)i(e);else{var o=new F(t,n.name);i(null,o)}}):i(new j.EBADF)}function vn(n,e,t,i,o){dn(t,o)&&dn(i,o)&&K(e,t,i,o)}function Nn(n,e,t,i){dn(t,i)&&H(e,t,i)}function In(e,t,i,o,a,u,c,r){a=void 0===a?0:a,u=void 0===u?o.length-a:u,r=arguments[arguments.length-1];var f=e.openFiles[i];f?n(f.flags).contains(p)?Y(t,f,o,a,u,c,function(n,e){r(n,e||0,o)}):r(new j.EBADF("descriptor does not permit reading")):r(new j.EBADF)}function hn(n,e,t,i,o){if(o=arguments[arguments.length-1],i=ln(i,null,"r"),dn(t,o)){var a=sn(i.flag||"r");if(!a)return o(new j.EINVAL("flags is not valid",t));X(e,t,a,function(u,c){if(u)return o(u);var r=new y(t,c.id,a,0),f=n.allocDescriptor(r);function s(){n.releaseDescriptor(f)}W(e,r,function(a,u){if(a)return s(),o(a);var c=new F(u,n.name);if(c.isDirectory())return s(),o(new j.EISDIR("illegal operation on directory",t));var f=c.size,l=new B(f);l.fill(0),Y(e,r,l,0,f,0,function(n,e){if(s(),n)return o(n);var t;t="utf8"===i.encoding?D.decode(l):l,o(null,t)})})})}}function An(e,t,i,o,a,u,c,r){r=arguments[arguments.length-1],a=void 0===a?0:a,u=void 0===u?o.length-a:u;var f=e.openFiles[i];f?n(f.flags).contains(w)?o.length-a<u?r(new j.EIO("intput buffer is too small")):q(t,f,o,a,u,c,r):r(new j.EBADF("descriptor does not permit writing")):r(new j.EBADF)}function Tn(n,e,t,i,o,a){if(a=arguments[arguments.length-1],o=ln(o,"utf8","w"),dn(t,a)){var u=sn(o.flag||"w");if(!u)return a(new j.EINVAL("flags is not valid",t));"number"==typeof(i=i||"")&&(i=""+i),"string"==typeof i&&"utf8"===o.encoding&&(i=D.encode(i)),X(e,t,u,function(o,c){if(o)return a(o);var r=new y(t,c.id,u,0),f=n.allocDescriptor(r);z(e,r,i,0,i.length,function(e,t){if(n.releaseDescriptor(f),e)return a(e);a(null)})})}}function Dn(n,e,t,i,o,a){if(a=arguments[arguments.length-1],o=ln(o,"utf8","a"),dn(t,a)){var u=sn(o.flag||"a");if(!u)return a(new j.EINVAL("flags is not valid",t));"number"==typeof(i=i||"")&&(i=""+i),"string"==typeof i&&"utf8"===o.encoding&&(i=D.encode(i)),X(e,t,u,function(o,c){if(o)return a(o);var r=new y(t,c.id,u,c.size),f=n.allocDescriptor(r);q(e,r,i,0,i.length,r.position,function(e,t){if(n.releaseDescriptor(f),e)return a(e);a(null)})})}}function jn(n,e,t,i){On(n,e,t,function(n,e){i(!n)})}function Rn(n,e,t,i,o){dn(t,o)&&un(e,t,i,o)}function yn(n,e,t,i,o){var a=n.openFiles[t];a?cn(e,a,i,o):o(new j.EBADF)}function Ln(n,e,t,i,o,a,u){"function"==typeof a&&(u=a,a=null),dn(t,u)&&on(e,t,i,o,a,u)}function Vn(e,t,i,o,a,u,c){"function"==typeof u&&(c=u,u=null);var r=e.openFiles[i];r?n(r.flags).contains(w)?an(t,r,o,a,u,c):c(new j.EBADF("descriptor does not permit writing")):c(new j.EBADF)}function Fn(n,e,t,i,o){dn(t,o)&&rn(e,t,i,o)}function Bn(e,t,i,o,a){var u=e.openFiles[i];u?n(u.flags).contains(w)?fn(t,u,o,a):a(new j.EBADF("descriptor does not permit writing")):a(new j.EBADF)}function _n(n,e,t,i,o,a){var u=n.openFiles[t];u||a(new j.EBADF),"SET"===o?i<0?a(new j.EINVAL("resulting file offset would be negative")):(u.position=i,a(null,u.position)):"CUR"===o?u.position+i<0?a(new j.EINVAL("resulting file offset would be negative")):(u.position+=i,a(null,u.position)):"END"===o?W(e,u,function(n,e){n?a(n):e.size+i<0?a(new j.EINVAL("resulting file offset would be negative")):(u.position=e.size+i,a(null,u.position))}):a(new j.EINVAL("whence argument is not a proper value"))}function xn(n,e,t,i){dn(t,i)&&J(e,t,i)}function Sn(n,e,t,i,o,a){if(dn(t,a)){var u=Date.now();en(e,t,i=i||u,o=o||u,a)}}function Cn(e,t,i,o,a,u){var c=Date.now();o=o||c,a=a||c;var r=e.openFiles[i];r?n(r.flags).contains(w)?tn(t,r,o,a,u):u(new j.EBADF("descriptor does not permit writing")):u(new j.EBADF)}function Pn(i,o,a,u,c){if(dn(a,c)&&dn(u,c)){a=t(a),u=t(u);var r,f,s,l,d=e.dirname(a),m=e.dirname(a),E=e.basename(a),p=e.basename(u);S(o,a,function(n,e){n?c(n):"DIRECTORY"===e.mode?S(o,d,h):K(o,a,u,A)})}function w(n,e){n?c(n):_(o,u,e,{ctime:Date.now()},c)}function g(n){n?c(n):o.getObject(l[p].id,w)}function O(n){n?c(n):(r.id===s.id&&(f=l),delete f[E],o.putObject(r.data,f,g))}function b(n){n?c(n):(l[p]=f[E],o.putObject(s.data,l,O))}function v(e,t){e?c(e):n(l=t).has(p)?M(o,u,b):b()}function N(n,e){n?c(n):(s=e,o.getObject(s.data,v))}function I(n,e){n?c(n):(f=e,S(o,m,N))}function h(n,e){n?c(n):(r=e,o.getObject(e.data,I))}function A(n){n?c(n):H(o,a,c)}}function kn(n,e,t,i,o,a){dn(t,a=arguments[arguments.length-1])&&dn(i,a)&&Q(e,t,i,a)}function Mn(n,e,t,i){dn(t,i)&&Z(e,t,i)}function Xn(n,e,t,i){dn(t,i)&&G(e,t,function(e,t){if(e)i(e);else{var o=new F(t,n.name);i(null,o)}})}function zn(n,e,t,i,o){i=i||0,dn(t,o=arguments[arguments.length-1])&&$(e,t,i,o)}function qn(e,t,i,o,a){a=arguments[arguments.length-1],o=o||0;var u=e.openFiles[i];u?n(u.flags).contains(w)?nn(t,u,o,a):a(new j.EBADF("descriptor does not permit writing")):a(new j.EBADF)}module.exports={ensureRootDirectory:P,open:mn,close:En,mknod:pn,mkdir:wn,rmdir:gn,unlink:Nn,stat:On,fstat:bn,link:vn,read:In,readFile:hn,write:An,writeFile:Tn,appendFile:Dn,exists:jn,getxattr:Rn,fgetxattr:yn,setxattr:Ln,fsetxattr:Vn,removexattr:Fn,fremovexattr:Bn,lseek:_n,readdir:xn,utimes:Sn,futimes:Cn,rename:Pn,symlink:kn,readlink:Mn,lstat:Xn,truncate:zn,ftruncate:qn};
},{"../../lib/nodash.js":14,"../path.js":4,"../constants.js":16,"../encoding.js":22,"../errors.js":5,"../directory-entry.js":50,"../open-file-description.js":51,"../super-node.js":52,"../node.js":53,"../stats.js":54,"../buffer.js":3}],6:[function(require,module,exports) {
var e=require("../../lib/nodash.js"),t=require("../path.js").isNull,r=require("../shared.js").nop,n=require("../constants.js"),i=n.FILE_SYSTEM_NAME,o=n.FS_FORMAT,a=n.FS_READY,u=n.FS_PENDING,s=n.FS_ERROR,c=n.FS_NODUPEIDCHECK,l=require("../providers/index.js"),f=require("../shell/shell.js"),d=require("../../lib/intercom.js"),h=require("../fs-watcher.js"),p=require("../errors.js"),v=require("../shared.js").guid,R=n.STDIN,g=n.STDOUT,E=n.STDERR,S=n.FIRST_DESCRIPTOR,y=require("./implementation.js");function m(e){return"function"==typeof e?e:function(e){if(e)throw e}}function x(e){e&&console.error("Filer error: ",e)}function F(n,m){m=m||x;var F=(n=n||{}).flags,j=n.guid?n.guid:v,q=n.provider||new l.Default(n.name||i),w=n.name||q.name,D=e(F).contains(o),O=this;O.readyState=u,O.name=w,O.error=null,O.stdin=R,O.stdout=g,O.stderr=E,this.Shell=f.bind(void 0,this);var T={},b=S;Object.defineProperty(this,"openFiles",{get:function(){return T}}),this.allocDescriptor=function(e){var t=b++;return T[t]=e,t},this.releaseDescriptor=function(e){delete T[e]};var C=[];function I(t){return function(r){e(F).contains(c)?r(null,j()):function e(r){var n=j();t.getObject(n,function(t,i){t?r(t):i?e(r):r(null,n)})}(r)}}this.queueOrRun=function(e){var t;return a==O.readyState?e.call(O):s==O.readyState?t=new p.EFILESYSTEMERROR("unknown error"):C.push(e),t},this.watch=function(e,n,i){if(t(e))throw new Error("Path must be a string without null bytes.");"function"==typeof n&&(i=n,n={}),n=n||{},i=i||r;var o=new h;return o.start(e,!1,n.recursive),o.on("change",i),o},q.open(function(e){function t(e){function t(e){var t=q[e]();return t.flags=F,t.changes=[],t.guid=I(t),t.close=function(){var e=t.changes;!function(e){if(e.length){var t=d.getInstance();e.forEach(function(e){t.emit(e.event,e.path)})}}(e),e.length=0},t}O.provider={openReadWriteContext:function(){return t("getReadWriteContext")},openReadOnlyContext:function(){return t("getReadOnlyContext")}},O.readyState=e?s:a,C.forEach(function(e){e.call(this)}.bind(O)),C=null,m(e,O)}if(e)return t(e);var r=q.getReadWriteContext();r.guid=I(r),D?r.clear(function(e){if(e)return t(e);y.ensureRootDirectory(r,t)}):y.ensureRootDirectory(r,t)})}F.providers=l,["open","close","mknod","mkdir","rmdir","stat","fstat","link","unlink","read","readFile","write","writeFile","appendFile","exists","lseek","readdir","rename","readlink","symlink","lstat","truncate","ftruncate","utimes","futimes","setxattr","getxattr","fsetxattr","fgetxattr","removexattr","fremovexattr"].forEach(function(e){F.prototype[e]=function(){var t=this,r=Array.prototype.slice.call(arguments,0),n=r.length-1,i="function"!=typeof r[n],o=m(r[n]),a=t.queueOrRun(function(){var a=t.provider.openReadWriteContext();if(s===t.readyState){var u=new p.EFILESYSTEMERROR("filesystem unavailable, operation canceled");return o.call(t,u)}function c(){a.close(),o.apply(t,arguments)}i?r.push(c):r[n]=c;var l=[t,a].concat(r);y[e].apply(null,l)});a&&o(a)}}),module.exports=F;
},{"../../lib/nodash.js":14,"../path.js":4,"../shared.js":15,"../constants.js":16,"../providers/index.js":19,"../shell/shell.js":7,"../../lib/intercom.js":17,"../fs-watcher.js":18,"../errors.js":5,"./implementation.js":20}],1:[function(require,module,exports) {
