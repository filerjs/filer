...
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer,r=require("es6-promisify"),t=r.promisify,n=require("../path.js"),s=require("../shared.js").nop,a=require("../constants.js"),o=a.FILE_SYSTEM_NAME,i=a.FS_FORMAT,u=a.FS_READY,m=a.FS_PENDING,c=a.FS_ERROR,f=a.FS_NODUPEIDCHECK,l=require("../providers/index.js"),h=require("../shell/shell.js"),p=require("../../lib/intercom.js"),d=require("../fs-watcher.js"),g=require("../errors.js"),b=require("../shared.js").guid,A=a.STDIN,P=a.STDOUT,v=a.STDERR,y=require("./implementation.js");function E(e){return"function"==typeof e?e:function(e){if(e)throw e}}function R(e){e&&console.error("Filer error: ",e)}function w(e){if(!(e&&e.protocol&&e.pathname))return e;if("file:"!==e.protocol)throw new g.EINVAL("only file: URLs are supported for paths",e);for(var r=e.pathname,t=0;t<r.length;t++)if("%"===r[t]){var n=32|r.codePointAt(t+2);if("2"===r[t+1]&&102===n)throw new g.EINVAL("file: URLs must not include encoded / characters",e)}return decodeURIComponent(r)}function S(r){return e.isBuffer(r)?r.toString():r}function O(e,r){return e?n.isNull(e)?new g.EINVAL("Path must be a string without null bytes.",e):r||n.isAbsolute(e)?void 0:new g.EINVAL("Path must be absolute.",e):new g.EINVAL("Path must be a string",e)}function x(e,r,t){var n=e[r],s=O(n=S(n=w(n)),t);if(s)throw s;e[r]=n}function F(e,r){r=r||R;var w=(e=e||{}).flags||[],S=e.guid?e.guid:b,O=e.provider||new l.Default(e.name||o),_=e.name||O.name,q=w.includes(i),C=this;C.readyState=m,C.name=_,C.error=null,C.stdin=A,C.stdout=P,C.stderr=v,C.constants=a.fsConstants,C.F_OK=a.fsConstants.F_OK,C.R_OK=a.fsConstants.R_OK,C.W_OK=a.fsConstants.W_OK,C.X_OK=a.fsConstants.X_OK,this.Shell=h.bind(void 0,this);var I=[];function N(e){return function(r){w.includes(f)?r(null,S()):function r(t){var n=S();e.getObject(n,function(e,s){e?t(e):s?r(t):t(null,n)})}(r)}}this.queueOrRun=function(e){var r;return u===C.readyState?e.call(C):c===C.readyState?r=new g.EFILESYSTEMERROR("unknown error"):I.push(e),r},this.watch=function(e,r,t){if(n.isNull(e))throw new Error("Path must be a string without null bytes.");"function"==typeof r&&(t=r,r={}),r=r||{},t=t||s;var a=new d;return a.start(e,!1,r.recursive),a.on("change",t),a},O.open(function(e){function t(e){function t(e){var r=O[e]();return r.name=_,r.flags=w,r.changes=[],r.guid=N(r),r.close=function(){var e=r.changes;!function(e){if(e.length){var r=p.getInstance();e.forEach(function(e){r.emit(e.event,e.path)})}}(e),e.length=0},r}C.provider={openReadWriteContext:function(){return t("getReadWriteContext")},openReadOnlyContext:function(){return t("getReadOnlyContext")}},C.readyState=e?c:u,I.forEach(function(e){e.call(this)}.bind(C)),I=null,r(e,C)}if(e)return t(e);var n=O.getReadWriteContext();n.guid=N(n),q?n.clear(function(e){if(e)return t(e);y.ensureRootDirectory(n,t)}):y.ensureRootDirectory(n,t)}),F.prototype.promises={},[{name:"appendFile",promises:!0,absPathArgs:[0]},{name:"access",promises:!0,absPathArgs:[0]},{name:"chown",promises:!0,absPathArgs:[0]},{name:"chmod",promises:!0,absPathArgs:[0]},{name:"close"},{name:"exists",absPathArgs:[0]},{name:"fchown"},{name:"fchmod"},{name:"fgetxattr"},{name:"fremovexattr"},{name:"fsetxattr"},{name:"fstat"},{name:"fsync"},{name:"ftruncate"},{name:"futimes"},{name:"getxattr",promises:!0,absPathArgs:[0]},{name:"link",promises:!0,absPathArgs:[0,1]},{name:"lseek"},{name:"lstat",promises:!0},{name:"mkdir",promises:!0,absPathArgs:[0]},{name:"mkdtemp",promises:!0},{name:"mknod",promises:!0,absPathArgs:[0]},{name:"open",promises:!0,absPathArgs:[0]},{name:"readdir",promises:!0,absPathArgs:[0]},{name:"read"},{name:"readFile",promises:!0,absPathArgs:[0]},{name:"readlink",promises:!0,absPathArgs:[0]},{name:"removexattr",promises:!0,absPathArgs:[0]},{name:"rename",promises:!0,absPathArgs:[0,1]},{name:"rmdir",promises:!0,absPathArgs:[0]},{name:"setxattr",promises:!0,absPathArgs:[0]},{name:"stat",promises:!0,absPathArgs:[0]},{name:"symlink",promises:!0,relPathArgs:[0],absPathArgs:[1]},{name:"truncate",promises:!0,absPathArgs:[0]},{name:"unlink",promises:!0,absPathArgs:[0]},{name:"utimes",promises:!0,absPathArgs:[0]},{name:"writeFile",promises:!0,absPathArgs:[0]},{name:"write"}].forEach(function(e){var r=e.name,n=!0===e.promises;F.prototype[r]=function(){var t=this,n=Array.prototype.slice.call(arguments,0),s=n.length-1,a="function"!=typeof n[s],o=E(n[s]);e.absPathArgs&&e.absPathArgs.forEach(function(e){return x(n,e,!1)}),e.relPathArgs&&e.relPathArgs.forEach(function(e){return x(n,e,!0)});var i=t.queueOrRun(function(){var e=t.provider.openReadWriteContext();if(c===t.readyState){var i=new g.EFILESYSTEMERROR("filesystem unavailable, operation canceled");return o.call(t,i)}function u(){e.close(),o.apply(t,arguments)}a?n.push(u):n[s]=u;var m=[e].concat(n);y[r].apply(null,m)});i&&o(i)},n&&(F.prototype.promises[r]=t(F.prototype[r].bind(C)))})}F.providers=l,module.exports=F;
},{"es6-promisify":"0c0E","../path.js":"8thZ","../shared.js":"zFPO","../constants.js":"gCho","../providers/index.js":"UCG6","../shell/shell.js":"Kf0M","../../lib/intercom.js":"u7Jv","../fs-watcher.js":"p3D+","../errors.js":"Hmaa","./implementation.js":"HvxC","buffer":"dskh"}],"2u/B":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
