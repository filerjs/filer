...
},{"path":"UUq2","process":"pBGv"}],"zFPO":[function(require,module,exports) {
...
},{}],"gCho":[function(require,module,exports) {
...
},{"../constants.js":"gCho","buffer":"dskh"}],"Hmaa":[function(require,module,exports) {
...
},{}],"wqt1":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var global = arguments[3];
...
},{"../constants.js":"gCho","../errors.js":"Hmaa","base64-arraybuffer":"vLJO","buffer":"dskh"}],"u4Zs":[function(require,module,exports) {
var process = require("process");
var define;
...
},{"./indexeddb.js":"aSGf","./websql.js":"wqt1","./memory.js":"Xhog"}],"lsut":[function(require,module,exports) {
...
var Buffer = require("buffer").Buffer;
var n=require("buffer").Buffer;function e(n){return(e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(n){return typeof n}:function(n){return n&&"function"==typeof Symbol&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n})(n)}var t=require("../path.js"),i=t.normalize,o=t.dirname,u=t.basename,r=t.isAbsolute,a=t.isNull,f=require("../shared.js"),c=require("../constants.js"),l=c.NODE_TYPE_FILE,s=c.NODE_TYPE_DIRECTORY,d=c.NODE_TYPE_SYMBOLIC_LINK,p=c.NODE_TYPE_META,m=c.FULL_READ_WRITE_EXEC_PERMISSIONS,E=c.ROOT_DIRECTORY_NAME,w=c.SUPER_NODE_ID,g=c.SYMLOOP_MAX,O=c.O_READ,b=c.O_WRITE,v=c.O_CREATE,y=c.O_EXCLUSIVE,N=c.O_APPEND,I=c.O_FLAGS,h=c.XATTR_CREATE,A=c.XATTR_REPLACE,D=c.FS_NOMTIME,T=c.FS_NOCTIME,j=require("../encoding.js"),L=require("../errors.js"),R=require("../directory-entry.js"),_=require("../open-file-description.js"),F=require("../super-node.js"),V=require("../node.js"),P=require("../stats.js");function S(n,e,t,i,o){var u=n.flags;u.includes(T)&&delete i.ctime,u.includes(D)&&delete i.mtime;var r=!1;function a(t){n.changes.push({event:"change",path:e}),o(t)}i.ctime&&(t.ctime=i.ctime,t.atime=i.ctime,r=!0),i.atime&&(t.atime=i.atime,r=!0),i.mtime&&(t.mtime=i.mtime,r=!0),r?n.putObject(t.id,t,a):a()}function B(n,e,t,r){if(t!==s&&t!==l)return r(new L.EINVAL("type must be a directory or file",e));e=i(e);var a,f,c,d=u(e),p=o(e);function m(t,i){!t&&i?r(new L.EEXIST("path name already exists",e)):!t||t instanceof L.ENOENT?n.getObject(a.data,E):r(t)}function E(e,i){e?r(e):(f=i,V.create({guid:n.guid,type:t},function(e,t){e?r(e):((c=t).nlinks+=1,n.putObject(c.id,c,g))}))}function w(e){if(e)r(e);else{var t=Date.now();S(n,p,c,{mtime:t,ctime:t},r)}}function g(e){e?r(e):(f[d]=new R(c.id,t),n.putObject(a.data,f,w))}x(n,p,function(t,i){t?r(t):i.type!==s?r(new L.ENOTDIR("a component of the path prefix is not a directory",e)):(a=i,x(n,e,m))})}function x(n,e,t){if(!(e=i(e)))return t(new L.ENOENT("path is an empty string"));var r=u(e),a=o(e),f=0;function c(e,i){if(e)return t(e);var o=new F(i);o&&o.type===p&&o.rnode?n.getObject(o.rnode,l):t(new L.EFILESYSTEMERROR)}function l(n,e){n?t(n):e?V.create(e,t):t(new L.ENOENT)}function m(i,o){i?t(i):o.type===s&&o.data?n.getObject(o.data,O):t(new L.ENOTDIR("a component of the path prefix is not a directory",e))}function O(i,o){if(i)t(i);else if(o.hasOwnProperty(r)){var u=o[r].id;n.getObject(u,b)}else t(new L.ENOENT(null,e))}function b(n,e){if(n)return t(n);V.create(e,v)}function v(l,s){var p;l?t(l):s.type===d?++f>g?t(new L.ELOOP(null,e)):(p=s.data,p=i(p),a=o(p),r=u(p),E===r?n.getObject(w,c):x(n,a,m)):t(null,s)}E===r?n.getObject(w,c):x(n,a,m)}function k(n,e,t,i,o,u,r){var a=t.xattrs;u===h&&a.hasOwnProperty(i)?r(new L.EEXIST("attribute already exists",e)):u!==A||a.hasOwnProperty(i)?(a[i]=o,n.putObject(t.id,t,function(i){i?r(i):S(n,e,t,{ctime:Date.now()},r)})):r(new L.ENOATTR(null,e))}function C(n,e){var t,i,o;function u(o){o?e(o):V.create({guid:n.guid,id:t.rnode,type:s},function(t,o){t?e(t):((i=o).nlinks+=1,n.putObject(i.id,i,r))})}function r(t){t?e(t):(o={},n.putObject(i.data,o,e))}n.getObject(w,function(i,o){!i&&o?e():!i||i instanceof L.ENOENT?F.create({guid:n.guid},function(i,o){i?e(i):(t=o,n.putObject(t.id,t,u))}):e(i)})}function X(n,e,t){e=i(e);var r,a,f,c,l=u(e),d=o(e);function p(e,i){e?t(e):(f=i,n.getObject(f.data,m))}function m(e,i){e?t(e):(c=i,V.create({guid:n.guid,type:s},function(e,i){e?t(e):((r=i).nlinks+=1,n.putObject(r.id,r,E))}))}function E(e){e?t(e):(a={},n.putObject(r.data,a,g))}function w(e){if(e)t(e);else{var i=Date.now();S(n,d,f,{mtime:i,ctime:i},t)}}function g(e){e?t(e):(c[l]=new R(r.id,s),n.putObject(f.data,c,w))}x(n,e,function(i,o){!i&&o?t(new L.EEXIST(null,e)):!i||i instanceof L.ENOENT?x(n,d,p):t(i)})}function M(n,e,t,o){var u=c.fsConstants,r=u.F_OK,a=u.R_OK,f=u.W_OK,l=u.X_OK,s=u.S_IXUSR,d=u.S_IXGRP,p=u.S_IXOTH;x(n,e=i(e),function(n,i){if(n)return o(n);if(t===r)return o(null);var u=Bn(i.mode,o);return u?t&(a|f)?o(null):t&l&&u&(s|d|p)?o(null):void o(new L.EACCES("permission denied",e)):void 0})}function q(n,e,t){e=i(e);var r,a,f,c,l=u(e),d=o(e);function p(i,o){i?t(i):E===l?t(new L.EBUSY(null,e)):o.hasOwnProperty(l)?(r=(c=o)[l].id,n.getObject(r,m)):t(new L.ENOENT(null,e))}function m(i,o){i?t(i):o.type!==s?t(new L.ENOTDIR(null,e)):(r=o,n.getObject(r.data,w))}function w(i,o){i?t(i):(a=o,Object.keys(a).length>0?t(new L.ENOTEMPTY(null,e)):(delete c[l],n.putObject(f.data,c,g)))}function g(e){if(e)t(e);else{var i=Date.now();S(n,d,f,{mtime:i,ctime:i},O)}}function O(e){e?t(e):n.delete(r.id,b)}function b(e){e?t(e):n.delete(r.data,t)}x(n,d,function(e,i){e?t(e):(f=i,n.getObject(f.data,p))})}function z(e,t,r,a,f){"function"==typeof a&&(f=a,a=null),t=i(t);var c,p,m,w,O,N=u(t),I=o(t),h=0;function A(n,i){n?f(n):i.type!==s?f(new L.ENOENT(null,t)):(c=i,e.getObject(c.data,D))}function D(n,i){n?f(n):(p=i).hasOwnProperty(N)?r.includes(y)?f(new L.ENOENT("O_CREATE and O_EXCLUSIVE are set, and the named file exists",t)):(m=p[N]).type===s&&r.includes(b)?f(new L.EISDIR("the named file is a directory and O_WRITE is set",t)):e.getObject(m.id,T):r.includes(v)?V.create({guid:e.guid,type:l},function(n,t){n?f(n):((w=t).nlinks+=1,a&&(w.mode=a),e.putObject(w.id,w,_))}):f(new L.ENOENT("O_CREATE is not set and the named file does not exist",t))}function T(n,a){if(n)f(n);else{var c=a;c.type===d?++h>g?f(new L.ELOOP(null,t)):function(n){n=i(n),I=o(n),N=u(n),E===N&&(r.includes(b)?f(new L.EISDIR("the named file is a directory and O_WRITE is set",t)):x(e,t,j));x(e,I,A)}(c.data):j(void 0,c)}}function j(n,e){n?f(n):f(null,w=e)}function _(t){t?f(t):(O=n.alloc(0),e.putBuffer(w.data,O,P))}function F(n){if(n)f(n);else{var t=Date.now();S(e,I,c,{mtime:t,ctime:t},B)}}function P(n){n?f(n):(p[N]=new R(w.id,l),e.putObject(c.data,p,F))}function B(n){n?f(n):f(null,w)}E===N?r.includes(b)?f(new L.EISDIR("the named file is a directory and O_WRITE is set",t)):x(e,t,j):x(e,I,A)}function Y(e,t,i,o,u,r){var a;function f(n){n?r(n):r(null,u)}function c(n){if(n)r(n);else{var i=Date.now();S(e,t.path,a,{mtime:i,ctime:i},f)}}function l(n){n?r(n):e.putObject(a.id,a,c)}e.getObject(t.id,function(f,c){if(f)r(f);else{a=c;var s=n.alloc(u);i.copy(s,0,o,o+u),t.position=u,a.size=u,a.version+=1,e.putBuffer(a.data,s,l)}})}function K(e,t,i,o,u,r,a){var f,c;function l(n){n?a(n):a(null,u)}function s(n){if(n)a(n);else{var i=Date.now();S(e,t.path,f,{mtime:i,ctime:i},l)}}function d(n){n?a(n):e.putObject(f.id,f,s)}function p(l,s){if(l)a(l);else{if(!(c=s))return a(new L.EIO("Expected Buffer"));var p=null!=r?r:t.position,m=Math.max(c.length,p+u),E=n.alloc(m);c&&c.copy(E),i.copy(E,p,o,o+u),void 0===r&&(t.position+=u),f.size=m,f.version+=1,e.putBuffer(f.data,E,d)}}e.getObject(t.id,function(n,t){n?a(n):(f=t,e.getBuffer(f.data,p))})}function U(n,e,t,i,o,u,r){var a,f;function c(n,a){if(n)r(n);else{if(!(f=a))return r(new L.EIO("Expected Buffer"));var c=null!=u?u:e.position;o=c+o>t.length?o-c:o,f.copy(t,i,c,c+o),void 0===u&&(e.position+=o),r(null,o)}}n.getObject(e.id,function(t,i){t?r(t):i.type===s?r(new L.EISDIR("the named file is a directory",e.path)):(a=i,n.getBuffer(a.data,c))})}function W(n,e,t){x(n,e=i(e),t)}function G(n,e,t){e.getNode(n,t)}function H(n,e,t){e=i(e);var r,a,f=u(e),c=o(e);function l(i,o){i?t(i):(a=o).hasOwnProperty(f)?n.getObject(a[f].id,t):t(new L.ENOENT("a component of the path does not name an existing file",e))}E===f?x(n,e,t):x(n,c,function(e,i){e?t(e):(r=i,n.getObject(r.data,l))})}function $(n,e,t,r){e=i(e);var a=u(e),f=o(e);t=i(t);var c,l,d,p,m,E,w=u(t),g=o(t),O=Date.now();function b(e){e?r(e):S(n,t,E,{ctime:O},r)}function v(e,t){e?r(e):((E=t).nlinks+=1,n.putObject(E.id,E,b))}function y(e){e?r(e):n.getObject(m,v)}function N(e,t){e?r(e):(p=t).hasOwnProperty(w)?r(new L.EEXIST("newpath resolves to an existing file",w)):(p[w]=l[a],m=p[w].id,n.putObject(d.data,p,y))}function I(e,t){e?r(e):(d=t,n.getObject(d.data,N))}function h(e,t){e?r(e):(l=t).hasOwnProperty(a)?l[a].type===s?r(new L.EPERM("oldpath refers to a directory")):x(n,g,I):r(new L.ENOENT("a component of either path prefix does not exist",a))}x(n,f,function(e,t){e?r(e):(c=t,n.getObject(c.data,h))})}function J(n,e,t){e=i(e);var r,a,f,c=u(e),l=o(e);function d(e){e?t(e):(delete a[c],n.putObject(r.data,a,function(e){if(e)t(e);else{var i=Date.now();S(n,l,r,{mtime:i,ctime:i},t)}}))}function p(e){e?t(e):n.delete(f.data,d)}function m(i,o){i?t(i):o.type===s?t(new L.EPERM("unlink not permitted on directories",c)):function(i,o){i?t(i):((f=o).nlinks-=1,f.nlinks<1?n.delete(f.id,p):n.putObject(f.id,f,function(i){i?t(i):S(n,e,f,{ctime:Date.now()},d)}))}(null,o)}function E(e,i){e?t(e):(a=i).hasOwnProperty(c)?n.getObject(a[c].id,m):t(new L.ENOENT("a component of the path does not name an existing file",c))}x(n,l,function(e,i){e?t(e):(r=i,n.getObject(r.data,E))})}function Q(n,e,t){var o,u;function r(n,e){if(n)t(n);else{u=e;var i=Object.keys(u);t(null,i)}}e=i(e),x(n,e,function(i,u){i?t(i):u.type!==s?t(new L.ENOTDIR(null,e)):(o=u,n.getObject(o.data,r))})}function Z(n,e,a,f){a=i(a);var c,l,s,p=u(a),m=o(a);function w(i,o){i?f(i):(l=o).hasOwnProperty(p)?f(new L.EEXIST(null,p)):V.create({guid:n.guid,type:d},function(i,o){i?f(i):((s=o).nlinks+=1,r(e)||(s.symlink_relpath=e,e=t.resolve(m,e)),s.size=e.length,s.data=e,n.putObject(s.id,s,O))})}function g(e){if(e)f(e);else{var t=Date.now();S(n,m,c,{mtime:t,ctime:t},f)}}function O(e){e?f(e):(l[p]=new R(s.id,d),n.putObject(c.data,l,g))}E===p?f(new L.EEXIST(null,p)):x(n,m,function(e,t){e?f(e):(c=t,n.getObject(c.data,w))})}function nn(n,e,t){e=i(e);var r,a,f=u(e),c=o(e);function l(e,i){e?t(e):(a=i).hasOwnProperty(f)?n.getObject(a[f].id,s):t(new L.ENOENT("a component of the path does not name an existing file",f))}function s(n,i){if(n)t(n);else if(i.type!==d)t(new L.EINVAL("path not a symbolic link",e));else{var o=i.symlink_relpath?i.symlink_relpath:i.data;t(null,o)}}x(n,c,function(e,i){e?t(e):(r=i,n.getObject(r.data,l))})}function en(e,t,o,u){var r;function a(t,i){if(t)u(t);else{if(!i)return u(new L.EIO("Expected Buffer"));var a=n.alloc(o);i&&i.copy(a),e.putBuffer(r.data,a,c)}}function f(n){if(n)u(n);else{var i=Date.now();S(e,t,r,{mtime:i,ctime:i},u)}}function c(n){n?u(n):(r.size=o,r.version+=1,e.putObject(r.id,r,f))}t=i(t),o<0?u(new L.EINVAL("length cannot be negative")):x(e,t,function(n,i){n?u(n):i.type===s?u(new L.EISDIR(null,t)):(r=i,e.getBuffer(r.data,a))})}function tn(e,t,i,o){var u;function r(t,r){if(t)o(t);else{var a;if(!r)return o(new L.EIO("Expected Buffer"));a=r?r.slice(0,i):n.alloc(i),e.putBuffer(u.data,a,f)}}function a(n){if(n)o(n);else{var i=Date.now();S(e,t.path,u,{mtime:i,ctime:i},o)}}function f(n){n?o(n):(u.size=i,u.version+=1,e.putObject(u.id,u,a))}i<0?o(new L.EINVAL("length cannot be negative")):t.getNode(e,function(n,t){n?o(n):t.type===s?o(new L.EISDIR):(u=t,e.getBuffer(u.data,r))})}function on(n,e,t,o,u){e=i(e),"number"!=typeof t||"number"!=typeof o?u(new L.EINVAL("atime and mtime must be number",e)):t<0||o<0?u(new L.EINVAL("atime and mtime must be positive integers",e)):x(n,e,function(i,r){i?u(i):S(n,e,r,{atime:t,ctime:o,mtime:o},u)})}function un(n,e,t,i,o){"number"!=typeof t||"number"!=typeof i?o(new L.EINVAL("atime and mtime must be a number")):t<0||i<0?o(new L.EINVAL("atime and mtime must be positive integers")):e.getNode(n,function(u,r){u?o(u):S(n,e.path,r,{atime:t,ctime:i,mtime:i},o)})}function rn(n,e,t,o,u,r){e=i(e),"string"!=typeof t?r(new L.EINVAL("attribute name must be a string",e)):t?null!==u&&u!==h&&u!==A?r(new L.EINVAL("invalid flag, must be null, XATTR_CREATE or XATTR_REPLACE",e)):x(n,e,function(i,a){if(i)return r(i);k(n,e,a,t,o,u,r)}):r(new L.EINVAL("attribute name cannot be an empty string",e))}function an(n,e,t,i,o,u){"string"!=typeof t?u(new L.EINVAL("attribute name must be a string")):t?null!==o&&o!==h&&o!==A?u(new L.EINVAL("invalid flag, must be null, XATTR_CREATE or XATTR_REPLACE")):e.getNode(n,function(r,a){if(r)return u(r);k(n,e.path,a,t,i,o,u)}):u(new L.EINVAL("attribute name cannot be an empty string"))}function fn(n,e,t,o){e=i(e),"string"!=typeof t?o(new L.EINVAL("attribute name must be a string",e)):t?x(n,e,function(n,i){if(n)return o(n);var u=i.xattrs;u.hasOwnProperty(t)?o(null,u[t]):o(new L.ENOATTR(null,e))}):o(new L.EINVAL("attribute name cannot be an empty string",e))}function cn(n,e,t,i){"string"!=typeof t?i(new L.EINVAL):t?e.getNode(n,function(n,e){if(n)return i(n);var o=e.xattrs;o.hasOwnProperty(t)?i(null,o[t]):i(new L.ENOATTR)}):i(new L.EINVAL("attribute name cannot be an empty string"))}function ln(n,e,t,o){e=i(e),"string"!=typeof t?o(new L.EINVAL("attribute name must be a string",e)):t?x(n,e,function(i,u){if(i)return o(i);var r=u.xattrs;r.hasOwnProperty(t)?(delete r[t],n.putObject(u.id,u,function(t){t?o(t):S(n,e,u,{ctime:Date.now()},o)})):o(new L.ENOATTR(null,e))}):o(new L.EINVAL("attribute name cannot be an empty string",e))}function sn(n,e,t,i){"string"!=typeof t?i(new L.EINVAL("attribute name must be a string")):t?e.getNode(n,function(o,u){if(o)return i(o);var r=u.xattrs;r.hasOwnProperty(t)?(delete r[t],n.putObject(u.id,u,function(t){t?i(t):S(n,e.path,u,{ctime:Date.now()},i)})):i(new L.ENOATTR)}):i(new L.EINVAL("attribute name cannot be an empty string"))}function dn(n){return I.hasOwnProperty(n)?I[n]:null}function pn(n,e,t){return n?"function"==typeof n?n={encoding:e,flag:t}:"string"==typeof n&&(n={encoding:n,flag:t}):n={encoding:e,flag:t},n}function mn(n,e,t){var i;return"function"==typeof e&&(t=e,e=!1),n?a(n)?i=new L.EINVAL("Path must be a string without null bytes.",n):e||r(n)||(i=new L.EINVAL("Path must be absolute.",n)):i=new L.EINVAL("Path must be a string",n),!i||(t(i),!1)}function En(n,e,t,i,o,u){if(arguments.length<6?(u=arguments[arguments.length-1],o=420):o=Bn(o,m,u),mn(t,u)){if(!(i=dn(i)))return u(new L.EINVAL("flags is not valid"),t);z(e,t,i,o,function(e,o){if(e)u(e);else{var r;r=i.includes(N)?o.size:0;var a=new _(t,o.id,i,r),f=n.allocDescriptor(a);u(null,f)}})}}function wn(n,e,t,i){n.openFiles[t]?(n.releaseDescriptor(t),i(null)):i(new L.EBADF)}function gn(n,e,t,i,o){mn(t,o)&&B(e,t,i,o)}function On(n,e,t,i,o){if(arguments.length<5)o=i,i=m;else if(!(i=Bn(i,m,o)))return;mn(t,o)&&X(e,t,o)}function bn(n,e,t,i,o){"function"==typeof i&&(o=i,i=c.fsConstants.F_OK),mn(t,o)&&M(e,t,i|=c.fsConstants.F_OK,o)}function vn(n,e,t,i,o){if(o=arguments[arguments.length-1],!t)return o(new Error("filename prefix is required"));var u=t+"-"+f.randomChars(6);mn(u,o)&&X(e,u,function(n){o(n,u)})}function yn(n,e,t,i){mn(t,i)&&q(e,t,i)}function Nn(n,e,t,i){mn(t,i)&&W(e,t,function(e,o){if(e)i(e);else{var u=new P(t,o,n.name);i(null,u)}})}function In(n,e,t,i){var o=n.openFiles[t];o?G(e,o,function(e,t){if(e)i(e);else{var u=new P(o.path,t,n.name);i(null,u)}}):i(new L.EBADF)}function hn(n,e,t,i,o){mn(t,o)&&mn(i,o)&&$(e,t,i,o)}function An(n,e,t,i){mn(t,i)&&J(e,t,i)}function Dn(n,e,t,i,o,u,r,a){o=void 0===o?0:o,u=void 0===u?i.length-o:u,a=arguments[arguments.length-1];var f=n.openFiles[t];f?f.flags.includes(O)?U(e,f,i,o,u,r,function(n,e){a(n,e||0,i)}):a(new L.EBADF("descriptor does not permit reading")):a(new L.EBADF)}function Tn(n,e,t,i){Vn(t,i)===t&&(n.openFiles[t]?i():i(new L.EBADF))}function jn(e,t,i,o,u){if(u=arguments[arguments.length-1],o=pn(o,null,"r"),mn(i,u)){var r=dn(o.flag||"r");if(!r)return u(new L.EINVAL("flags is not valid",i));z(t,i,r,function(a,f){if(a)return u(a);var c=new _(i,f.id,r,0),l=e.allocDescriptor(c);function s(){e.releaseDescriptor(l)}G(t,c,function(r,a){if(r)return s(),u(r);var f=new P(c.path,a,e.name);if(f.isDirectory())return s(),u(new L.EISDIR("illegal operation on directory",i));var l=f.size,d=n.alloc(l);U(t,c,d,0,l,0,function(n){if(s(),n)return u(n);var e;e="utf8"===o.encoding?j.decode(d):d,u(null,e)})})})}}function Ln(n,e,t,i,o,u,r,a){a=arguments[arguments.length-1],o=void 0===o?0:o,u=void 0===u?i.length-o:u;var f=n.openFiles[t];f?f.flags.includes(b)?i.length-o<u?a(new L.EIO("input buffer is too small")):K(e,f,i,o,u,r,a):a(new L.EBADF("descriptor does not permit writing")):a(new L.EBADF)}function Rn(n,e,t,i,o,u){if(u=arguments[arguments.length-1],o=pn(o,"utf8","w"),mn(t,u)){var r=dn(o.flag||"w");if(!r)return u(new L.EINVAL("flags is not valid",t));"number"==typeof(i=i||"")&&(i=""+i),"string"==typeof i&&"utf8"===o.encoding&&(i=j.encode(i)),z(e,t,r,function(o,a){if(o)return u(o);var f=new _(t,a.id,r,0),c=n.allocDescriptor(f);Y(e,f,i,0,i.length,function(e){if(n.releaseDescriptor(c),e)return u(e);u(null)})})}}function _n(n,e,t,i,o,u){if(u=arguments[arguments.length-1],o=pn(o,"utf8","a"),mn(t,u)){var r=dn(o.flag||"a");if(!r)return u(new L.EINVAL("flags is not valid",t));"number"==typeof(i=i||"")&&(i=""+i),"string"==typeof i&&"utf8"===o.encoding&&(i=j.encode(i)),z(e,t,r,function(o,a){if(o)return u(o);var f=new _(t,a.id,r,a.size),c=n.allocDescriptor(f);K(e,f,i,0,i.length,f.position,function(e){if(n.releaseDescriptor(c),e)return u(e);u(null)})})}}function Fn(n,e,t,i){Nn(n,e,t,function(n){i(!n)})}function Vn(n,e){if("number"==typeof n)return n;e(new L.EINVAL("Expected integer",n))}var Pn=/^[0-7]+$/;function Sn(n){return n===n>>>0}function Bn(n,e,t){return"function"==typeof e&&(t=e,e=void 0),Sn(n)?n&m:"number"==typeof n?(Number.isInteger(n),t(new L.EINVAL("mode not a valid an integer value",n)),!1):"string"==typeof n?Pn.test(n)?parseInt(n,8)&m:(t(new L.EINVAL("mode not a valid octal string",n)),!1):void 0!==e?e:(t(new L.EINVAL("mode not valid",n)),!1)}function xn(n,e,t,o){e=i(e),"number"!=typeof t?o(new L.EINVAL("mode must be number",e)):x(n,e,function(i,u){i?o(i):(u.mode=t,S(n,e,u,{mtime:Date.now()},o))})}function kn(n,e,t,i){"number"!=typeof t?i(new L.EINVAL("mode must be a number")):e.getNode(n,function(o,u){o?i(o):(u.mode=t,S(n,e.path,u,{mtime:Date.now()},i))})}function Cn(n,e,t,o,u){e=i(e),x(n,e,function(i,r){i?u(i):(r.uid=t,r.gid=o,S(n,e,r,{mtime:Date.now()},u))})}function Xn(n,e,t,i,o){e.getNode(n,function(u,r){u?o(u):(r.uid=t,r.gid=i,S(n,e.path,r,{mtime:Date.now()},o))})}function Mn(n,e,t,i,o){mn(t,o)&&fn(e,t,i,o)}function qn(n,e,t,i,o){var u=n.openFiles[t];u?cn(e,u,i,o):o(new L.EBADF)}function zn(n,e,t,i,o,u,r){"function"==typeof u&&(r=u,u=null),mn(t,r)&&rn(e,t,i,o,u,r)}function Yn(n,e,t,i,o,u,r){"function"==typeof u&&(r=u,u=null);var a=n.openFiles[t];a?a.flags.includes(b)?an(e,a,i,o,u,r):r(new L.EBADF("descriptor does not permit writing")):r(new L.EBADF)}function Kn(n,e,t,i,o){mn(t,o)&&ln(e,t,i,o)}function Un(n,e,t,i,o){var u=n.openFiles[t];u?u.flags.includes(b)?sn(e,u,i,o):o(new L.EBADF("descriptor does not permit writing")):o(new L.EBADF)}function Wn(n,e,t,i,o,u){var r=n.openFiles[t];r||u(new L.EBADF),"SET"===o?i<0?u(new L.EINVAL("resulting file offset would be negative")):(r.position=i,u(null,r.position)):"CUR"===o?r.position+i<0?u(new L.EINVAL("resulting file offset would be negative")):(r.position+=i,u(null,r.position)):"END"===o?G(e,r,function(n,e){n?u(n):e.size+i<0?u(new L.EINVAL("resulting file offset would be negative")):(r.position=e.size+i,u(null,r.position))}):u(new L.EINVAL("whence argument is not a proper value"))}function Gn(n,e,t,i){mn(t,i)&&Q(e,t,i)}function Hn(n){return"number"==typeof n?n:"object"===e(n)&&"function"==typeof n.getTime?n.getTime()/1e3:void 0}function $n(n,e,t,i,o,u){if(mn(t,u)){var r=Date.now();on(e,t,i=Hn(i||r),o=Hn(o||r),u)}}function Jn(n,e,t,i,o,u){var r=Date.now();i=Hn(i||r),o=Hn(o||r);var a=n.openFiles[t];a?a.flags.includes(b)?un(e,a,i,o,u):u(new L.EBADF("descriptor does not permit writing")):u(new L.EBADF)}function Qn(n,e,t,i,o){mn(t,o)&&(i=Bn(i,o))&&xn(e,t,i,o)}function Zn(n,e,t,i,o){if(i=Bn(i,o)){var u=n.openFiles[t];u?u.flags.includes(b)?kn(e,u,i,o):o(new L.EBADF("descriptor does not permit writing")):o(new L.EBADF)}}function ne(n,e,t,i,o,u){if(mn(t,u))return Sn(i)?Sn(o)?void Cn(e,t,i,o,u):u(new L.EINVAL("gid must be a valid integer",o)):u(new L.EINVAL("uid must be a valid integer",i))}function ee(n,e,t,i,o,u){if(!Sn(i))return u(new L.EINVAL("uid must be a valid integer",i));if(!Sn(o))return u(new L.EINVAL("gid must be a valid integer",o));var r=n.openFiles[t];r?r.flags.includes(b)?Xn(e,r,i,o,u):u(new L.EBADF("descriptor does not permit writing")):u(new L.EBADF)}function te(n,e,o,u,r){if(mn(o,r)&&mn(u,r)){o=i(o),u=i(u);var a,f,c,l,d=t.dirname(o),p=t.dirname(o),m=t.basename(o),E=t.basename(u),w=Date.now();x(e,o,function(n,t){n?r(n):t.type===s?x(e,d,h):$(e,o,u,A)})}function g(n,t){n?r(n):S(e,u,t,{ctime:w},r)}function O(n){n?r(n):e.getObject(l[E].id,g)}function b(n){n?r(n):(a.id===c.id&&(f=l),delete f[m],e.putObject(a.data,f,O))}function v(n){n?r(n):(l[E]=f[m],e.putObject(c.data,l,b))}function y(n,t){n?r(n):(l=t).hasOwnProperty(E)?q(e,u,v):v()}function N(n,t){n?r(n):(c=t,e.getObject(c.data,y))}function I(n,t){n?r(n):(f=t,x(e,p,N))}function h(n,t){n?r(n):(a=t,e.getObject(t.data,I))}function A(n){n?r(n):J(e,o,r)}}function ie(n,e,t,i,o,u){mn(t,!0,u=arguments[arguments.length-1])&&mn(i,u)&&Z(e,t,i,u)}function oe(n,e,t,i){mn(t,i)&&nn(e,t,i)}function ue(n,e,t,i){mn(t,i)&&H(e,t,function(e,o){if(e)i(e);else{var u=new P(t,o,n.name);i(null,u)}})}function re(n,e,t,i,o){i=i||0,mn(t,o=arguments[arguments.length-1])&&Vn(i,o)===i&&en(e,t,i,o)}function ae(n,e,t,i,o){o=arguments[arguments.length-1],i=i||0;var u=n.openFiles[t];if(u)if(u.flags.includes(b)){if(Vn(i,o)!==i)return;tn(e,u,i,o)}else o(new L.EBADF("descriptor does not permit writing"));else o(new L.EBADF)}module.exports={ensureRootDirectory:C,open:En,chmod:Qn,access:bn,fchmod:Zn,chown:ne,fchown:ee,close:wn,mknod:gn,mkdir:On,mkdtemp:vn,rmdir:yn,unlink:An,stat:Nn,fstat:In,link:hn,fsync:Tn,read:Dn,readFile:jn,write:Ln,writeFile:Rn,appendFile:_n,exists:Fn,getxattr:Mn,fgetxattr:qn,setxattr:zn,fsetxattr:Yn,removexattr:Kn,fremovexattr:Un,lseek:Wn,readdir:Gn,utimes:$n,futimes:Jn,rename:te,symlink:ie,readlink:oe,lstat:ue,truncate:re,ftruncate:ae};
},{"../path.js":"8thZ","../shared.js":"zFPO","../constants.js":"gCho","../encoding.js":"u0zp","../errors.js":"Hmaa","../directory-entry.js":"RlAD","../open-file-description.js":"E+68","../super-node.js":"3YM/","../node.js":"epsH","../stats.js":"OfGU","buffer":"dskh"}],"Q4+W":[function(require,module,exports) {
...
},{"es6-promisify":"0c0E","../path.js":"8thZ","../shared.js":"zFPO","../constants.js":"gCho","../providers/index.js":"UCG6","../shell/shell.js":"Kf0M","../../lib/intercom.js":"u7Jv","../fs-watcher.js":"p3D+","../errors.js":"Hmaa","./implementation.js":"HvxC"}],"2u/B":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
